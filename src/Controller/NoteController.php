...
class NoteController extends AbstractController
{
    ...
    public function new(Request $request): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            $note->setCreation(new \DateTime("now"));
    ...
    /**
     * @Route("/delete/{id}", name="note_delete", methods={"DELETE"})
     */
    public function delete(Request $request, Note $note, Security $security): Response
    {
        if ( !($this->getUser()) ) {
            return $this->redirectToRoute('app_login');
        }
